...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name all_msgs-msg:<Position> is deprecated: use all_msgs-msg:Position instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader all_msgs-msg:latitude-val is deprecated.  Use all_msgs-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader all_msgs-msg:longitude-val is deprecated.  Use all_msgs-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Position>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Position>)))
  ...
  "2eb7dcbe507b4e4bd3e8128ce0dc99e1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Position)))
  "Returns md5sum for a message object of type 'Position"
  "2eb7dcbe507b4e4bd3e8128ce0dc99e1")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Position>)))
  ...
  (cl:format cl:nil "float64 latitude~%float64 longitude~%float64 height~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Position)))
  "Returns full string definition for message of type 'Position"
  (cl:format cl:nil "float64 latitude~%float64 longitude~%float64 height~%~%~%"))
