// Generated by gencpp from file all_msgs/LidarFrameMsg.msg
// DO NOT EDIT!


#ifndef ALL_MSGS_MESSAGE_LIDARFRAMEMSG_H
#define ALL_MSGS_MESSAGE_LIDARFRAMEMSG_H
...
#include <all_msgs/Point3d.h>
#include <all_msgs/PoseMap.h>
#include <std_msgs/Int32.h>
#include <all_msgs/Indices.h>
#include <all_msgs/Objects.h>
#include <std_msgs/Bool.h>
#include <all_msgs/Point4f.h>
#include <std_msgs/Bool.h>
#include <all_msgs/Objects.h>
#include <std_msgs/Bool.h>
#include <all_msgs/FreeSpaceInfos.h>
#include <std_msgs/Bool.h>
#include <all_msgs/Lanes.h>
#include <std_msgs/Bool.h>
#include <all_msgs/RoadEdges.h>
#include <std_msgs/Bool.h>
#include <all_msgs/Indices.h>
#include <all_msgs/Indices.h>
#include <all_msgs/Indices.h>
...
struct LidarFrameMsg_
{
  ...
  _timestamp_type timestamp;
   ...
   typedef  ::all_msgs::Pose_<ContainerAllocator>  _global_pose_type;
  _global_pose_type global_pose;

   typedef  ::all_msgs::Point3d_<ContainerAllocator>  _gps_origin_type;
  _gps_origin_type gps_origin;

   typedef  ::all_msgs::PoseMap_<ContainerAllocator>  _status_pose_map_type;
  _status_pose_map_type status_pose_map;

   typedef  ::std_msgs::Int32_<ContainerAllocator>  _status_type;
  _status_type status;

   typedef  ::all_msgs::Indices_<ContainerAllocator>  _valid_indices_type;
  _valid_indices_type valid_indices;

   typedef  ::all_msgs::Objects_<ContainerAllocator>  _objects_type;
  _objects_type objects;

   typedef  ::std_msgs::Bool_<ContainerAllocator>  _has_pointcloud_type;
  _has_pointcloud_type has_pointcloud;

   typedef std::vector< ::all_msgs::Point4f_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::all_msgs::Point4f_<ContainerAllocator> >> _scan_pointcloud_type;
  ...
  _has_attention_objects_type has_attention_objects;
   ...
   typedef  ::all_msgs::Objects_<ContainerAllocator>  _attention_objects_type;
  ...
  _has_sematice_indices_type has_sematice_indices;
   ...
   typedef  ::all_msgs::Indices_<ContainerAllocator>  _non_ground_indices_type;
  _non_ground_indices_type non_ground_indices;

   typedef  ::all_msgs::Indices_<ContainerAllocator>  _ground_indices_type;
  _ground_indices_type ground_indices;

   typedef  ::all_msgs::Indices_<ContainerAllocator>  _background_indices_type;
  ...
  typedef boost::shared_ptr< ::all_msgs::LidarFrameMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::all_msgs::LidarFrameMsg_<ContainerAllocator> const> ConstPtr;

}; // struct LidarFrameMsg_

typedef ::all_msgs::LidarFrameMsg_<std::allocator<void> > LidarFrameMsg;

typedef boost::shared_ptr< ::all_msgs::LidarFrameMsg > LidarFrameMsgPtr;
typedef boost::shared_ptr< ::all_msgs::LidarFrameMsg const> LidarFrameMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::all_msgs::LidarFrameMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::all_msgs::LidarFrameMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::all_msgs::LidarFrameMsg_<ContainerAllocator1> & lhs, const ::all_msgs::LidarFrameMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::all_msgs::LidarFrameMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::all_msgs::LidarFrameMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::all_msgs::LidarFrameMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::all_msgs::LidarFrameMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::all_msgs::LidarFrameMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::all_msgs::LidarFrameMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::all_msgs::LidarFrameMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::all_msgs::LidarFrameMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xcaa4cd6acb7dc86fULL;
  static const uint64_t static_value2 = 0x4a76180c583c5946ULL;
};

template<class ContainerAllocator>
struct DataType< ::all_msgs::LidarFrameMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::all_msgs::LidarFrameMsg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "std_msgs/String frame_id\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::all_msgs::LidarFrameMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::all_msgs::LidarFrameMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::all_msgs::LidarFrameMsg_<ContainerAllocator>& v)
  {
    s << indent << "frame_id: ";
    s << std::endl;
    ...
    s << std::endl;
    Printer< ::all_msgs::Pose_<ContainerAllocator> >::stream(s, indent + "  ", v.global_pose);
    s << indent << "gps_origin: ";
    s << std::endl;
    Printer< ::all_msgs::Point3d_<ContainerAllocator> >::stream(s, indent + "  ", v.gps_origin);
    s << indent << "status_pose_map: ";
    s << std::endl;
    Printer< ::all_msgs::PoseMap_<ContainerAllocator> >::stream(s, indent + "  ", v.status_pose_map);
    s << indent << "status: ";
    s << std::endl;
    Printer< ::std_msgs::Int32_<ContainerAllocator> >::stream(s, indent + "  ", v.status);
    s << indent << "valid_indices: ";
    s << std::endl;
    Printer< ::all_msgs::Indices_<ContainerAllocator> >::stream(s, indent + "  ", v.valid_indices);
    s << indent << "objects: ";
    s << std::endl;
    Printer< ::all_msgs::Objects_<ContainerAllocator> >::stream(s, indent + "  ", v.objects);
    ...
    for (size_t i = 0; i < v.scan_pointcloud.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::all_msgs::Point4f_<ContainerAllocator> >::stream(s, indent + "    ", v.scan_pointcloud[i]);
    }
    ...
    s << std::endl;
    Printer< ::all_msgs::Objects_<ContainerAllocator> >::stream(s, indent + "  ", v.attention_objects);
    s << indent << "has_freespace: ";
    s << std::endl;
    Printer< ::std_msgs::Bool_<ContainerAllocator> >::stream(s, indent + "  ", v.has_freespace);
    s << indent << "freespace_infos: ";
    s << std::endl;
    Printer< ::all_msgs::FreeSpaceInfos_<ContainerAllocator> >::stream(s, indent + "  ", v.freespace_infos);
    s << indent << "has_lanes: ";
    s << std::endl;
    Printer< ::std_msgs::Bool_<ContainerAllocator> >::stream(s, indent + "  ", v.has_lanes);
    s << indent << "lanes: ";
    s << std::endl;
    Printer< ::all_msgs::Lanes_<ContainerAllocator> >::stream(s, indent + "  ", v.lanes);
    s << indent << "has_roadedges: ";
    s << std::endl;
    Printer< ::std_msgs::Bool_<ContainerAllocator> >::stream(s, indent + "  ", v.has_roadedges);
    s << indent << "roadedges: ";
    s << std::endl;
    Printer< ::all_msgs::RoadEdges_<ContainerAllocator> >::stream(s, indent + "  ", v.roadedges);
    ...
    s << std::endl;
    Printer< ::all_msgs::Indices_<ContainerAllocator> >::stream(s, indent + "  ", v.non_ground_indices);
    s << indent << "ground_indices: ";
    s << std::endl;
    Printer< ::all_msgs::Indices_<ContainerAllocator> >::stream(s, indent + "  ", v.ground_indices);
    s << indent << "background_indices: ";
    s << std::endl;
    Printer< ::all_msgs::Indices_<ContainerAllocator> >::stream(s, indent + "  ", v.background_indices);
  }
};
...
#endif // ALL_MSGS_MESSAGE_LIDARFRAMEMSG_H
