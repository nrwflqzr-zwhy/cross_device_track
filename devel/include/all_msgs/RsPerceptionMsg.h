// Generated by gencpp from file all_msgs/RsPerceptionMsg.msg
// DO NOT EDIT!


#ifndef ALL_MSGS_MESSAGE_RSPERCEPTIONMSG_H
#define ALL_MSGS_MESSAGE_RSPERCEPTIONMSG_H
...
#include <all_msgs/LidarFrameMsg.h>
...
struct RsPerceptionMsg_
{
  ...
  (void)_alloc;
   ...
   typedef  ::all_msgs::LidarFrameMsg_<ContainerAllocator>  _lidarframe_type;
  ...
  typedef boost::shared_ptr< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> const> ConstPtr;

}; // struct RsPerceptionMsg_

typedef ::all_msgs::RsPerceptionMsg_<std::allocator<void> > RsPerceptionMsg;

typedef boost::shared_ptr< ::all_msgs::RsPerceptionMsg > RsPerceptionMsgPtr;
typedef boost::shared_ptr< ::all_msgs::RsPerceptionMsg const> RsPerceptionMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::all_msgs::RsPerceptionMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::all_msgs::RsPerceptionMsg_<ContainerAllocator1> & lhs, const ::all_msgs::RsPerceptionMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::all_msgs::RsPerceptionMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6ed114efee5ecd5eULL;
  static const uint64_t static_value2 = 0x94f0dbd1aa700b6dULL;
};

template<class ContainerAllocator>
struct DataType< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::all_msgs::RsPerceptionMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::all_msgs::RsPerceptionMsg_<ContainerAllocator>& v)
  {
    s << indent << "lidarframe: ";
    s << std::endl;
    Printer< ::all_msgs::LidarFrameMsg_<ContainerAllocator> >::stream(s, indent + "  ", v.lidarframe);
    s << indent << "device_id: ";
    s << std::endl;
...
#endif // ALL_MSGS_MESSAGE_RSPERCEPTIONMSG_H
