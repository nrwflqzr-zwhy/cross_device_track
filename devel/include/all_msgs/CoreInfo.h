// Generated by gencpp from file all_msgs/CoreInfo.msg
// DO NOT EDIT!


#ifndef ALL_MSGS_MESSAGE_COREINFO_H
#define ALL_MSGS_MESSAGE_COREINFO_H
...
struct CoreInfo_
{
  ...
  _center_type center;
   ...
   typedef  ::all_msgs::Point3f_<ContainerAllocator>  _center_cov_type;
  _center_cov_type center_cov;

   typedef  ::all_msgs::Point3f_<ContainerAllocator>  _size_type;
  _size_type size;

   typedef  ::all_msgs::Point3f_<ContainerAllocator>  _size_cov_type;
  _size_cov_type size_cov;

   typedef  ::all_msgs::Point3f_<ContainerAllocator>  _direction_type;
  _direction_type direction;

   typedef  ::all_msgs::Point3f_<ContainerAllocator>  _direction_cov_type;
  ...
  _velocity_type velocity;
   ...
   typedef  ::all_msgs::Point3f_<ContainerAllocator>  _velocity_cov_type;
  _velocity_cov_type velocity_cov;

   typedef  ::all_msgs::Point3f_<ContainerAllocator>  _acceleration_type;
  _acceleration_type acceleration;

   typedef  ::all_msgs::Point3f_<ContainerAllocator>  _acceleration_cov_type;
  ...
  _angle_acceleration_cov_type angle_acceleration_cov;
   ...
   typedef  ::all_msgs::Point3f_<ContainerAllocator>  _anchor_type;
  _anchor_type anchor;

   typedef  ::all_msgs::Point3f_<ContainerAllocator>  _nearest_point_type;
  ...
  typedef boost::shared_ptr< ::all_msgs::CoreInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::all_msgs::CoreInfo_<ContainerAllocator> const> ConstPtr;

}; // struct CoreInfo_

typedef ::all_msgs::CoreInfo_<std::allocator<void> > CoreInfo;

typedef boost::shared_ptr< ::all_msgs::CoreInfo > CoreInfoPtr;
typedef boost::shared_ptr< ::all_msgs::CoreInfo const> CoreInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::all_msgs::CoreInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::all_msgs::CoreInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::all_msgs::CoreInfo_<ContainerAllocator1> & lhs, const ::all_msgs::CoreInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::all_msgs::CoreInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::all_msgs::CoreInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::all_msgs::CoreInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::all_msgs::CoreInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::all_msgs::CoreInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::all_msgs::CoreInfo_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::all_msgs::CoreInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::all_msgs::CoreInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7f0ff990bf278ab8ULL;
  static const uint64_t static_value2 = 0x7b544233b3a79e70ULL;
};

template<class ContainerAllocator>
struct DataType< ::all_msgs::CoreInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::all_msgs::CoreInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::all_msgs::CoreInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::all_msgs::CoreInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::all_msgs::CoreInfo_<ContainerAllocator>& v)
  {
    s << indent << "timestamp: ";
    s << std::endl;
    ...
    s << indent << "center_cov: ";
    s << std::endl;
    Printer< ::all_msgs::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.center_cov);
    s << indent << "size: ";
    s << std::endl;
    Printer< ::all_msgs::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.size);
    s << indent << "size_cov: ";
    s << std::endl;
    Printer< ::all_msgs::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.size_cov);
    s << indent << "direction: ";
    s << std::endl;
    Printer< ::all_msgs::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.direction);
    s << indent << "direction_cov: ";
    s << std::endl;
    Printer< ::all_msgs::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.direction_cov);
    s << indent << "type: ";
    s << std::endl;
    ...
    s << std::endl;
    Printer< ::all_msgs::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.velocity_cov);
    s << indent << "acceleration: ";
    s << std::endl;
    Printer< ::all_msgs::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.acceleration);
    s << indent << "acceleration_cov: ";
    s << std::endl;
    Printer< ::all_msgs::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.acceleration_cov);
    ...
    s << indent << "anchor: ";
    s << std::endl;
    Printer< ::all_msgs::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.anchor);
    s << indent << "nearest_point: ";
    s << std::endl;
    Printer< ::all_msgs::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.nearest_point);
  }
};
...
#endif // ALL_MSGS_MESSAGE_COREINFO_H
