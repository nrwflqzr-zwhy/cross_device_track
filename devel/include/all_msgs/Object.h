...
#include <all_msgs/CoreInfo.h>
#include <std_msgs/Bool.h>
#include <all_msgs/SupplementInfo.h>
...
struct Object_
{
  ...
  (void)_alloc;
   ...
   typedef  ::all_msgs::CoreInfo_<ContainerAllocator>  _coreinfo_type;
  ...
  _hassupplmentinfo_type hassupplmentinfo;
   ...
   typedef  ::all_msgs::SupplementInfo_<ContainerAllocator>  _supplementinfo_type;
...
bool operator==(const ::all_msgs::Object_<ContainerAllocator1> & lhs, const ::all_msgs::Object_<ContainerAllocator2> & rhs)
{
...
struct Printer< ::all_msgs::Object_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::all_msgs::Object_<ContainerAllocator>& v)
  {
    s << indent << "coreinfo: ";
    s << std::endl;
    Printer< ::all_msgs::CoreInfo_<ContainerAllocator> >::stream(s, indent + "  ", v.coreinfo);
    ...
    s << std::endl;
    Printer< ::all_msgs::SupplementInfo_<ContainerAllocator> >::stream(s, indent + "  ", v.supplementinfo);
  }
};
