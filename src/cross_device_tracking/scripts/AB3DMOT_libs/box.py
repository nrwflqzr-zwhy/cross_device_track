...
Date: 2023-06-30 11:11:36
LastEditors: zwhy wa22201149@stu.ahu.edu.cn
LastEditTime: 2023-06-30 16:21:10
FilePath: /cross_device_track/src/cross_device_tracking/scripts/AB3DMOT_libs/box.py
Description: 
'''
import sys
path = "/home/zwhy/workspace/cross_device_track"
# 核心
sys.path.insert(0, path + "/src/cross_device_tracking/scripts/AB3DMOT_libs")
import numpy as np
